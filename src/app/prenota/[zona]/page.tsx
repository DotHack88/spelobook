...
const MOCK_CAVES: Record<string, Grotta[]> = {
  ...
  sicilia: [
    ...
    {
      id: 'sic-4', zona_id: '5', slug: 'grotta-azzurra-capri', nome: 'Grotta Azzurra (Capri)',
      tipologia: 'marina', difficolta: 'facile', profondita_mt: 5, lunghezza_mt: 60,
      max_persone: 25, min_persone: 2,
      immagini: ['https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&q=80&w=800'],
      descrizione: "Celebre in tutto il mondo per l'intensa colorazione blu dell'acqua causata dalla rifrazione della luce solare. Un'esperienza visiva unica e indimenticabile.",
    },
  ],
};
